...
% Sample data calibration program is for accelerometer 
% it logs the data in a file for later use
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
filename = '../Data/Cal_Data_0.dat'; %To store calibration data file
fid1 = fopen(filename,'w');
%% End of user required information ensure channel number is correctly set for accelerometer
d = daq.getDevices;
s = daq.createSession('ni');
addAnalogInputChannel(s,'myDAQ1',['ai1'],'Voltage'); % Make sure to use the right channel for accelerometer data
...
voltage = event.Data; %Accelerometer data in voltage 
figure(1)
