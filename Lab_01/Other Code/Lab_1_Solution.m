...
dataTable1 = table(time_1', voltage_data_1, 'VariableNames', {'Time', 'Volts'});
dataTable2 = table(time_2', voltage_data_2, 'VariableNames', {'Time', 'Volts'});

% Save the table to a CSV file
writetable(dataTable1, 'time_volts_data_example.csv');
writetable(dataTable2, 'time_volts_data.csv');
