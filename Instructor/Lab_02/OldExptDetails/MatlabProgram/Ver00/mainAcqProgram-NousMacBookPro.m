...
outputFileName = 'Test.dat'; % This program will overwrite the file
slope = 1; % Slope for converting voltage to appropriate unit
intercept = 0; % Intercept for converting voltage to appropriate unit
Fs = 30; %Sampling rate Data per sec
T  = 3; % Time to acquire data
choice = 0; %% Set to 1 to write data to a file otherwise 0
