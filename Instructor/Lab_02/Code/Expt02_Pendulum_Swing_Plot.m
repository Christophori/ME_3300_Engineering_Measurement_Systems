...
title('FirstName LastName''s Pendulum Swing Plot')

text(12,70,sprintf('T_d = %4.3f s',T_d),'Fontname','times')
text(12,60,sprintf('\\omega_d = %4.3f rad/s',w_d_e),'FontName','Times','Interpreter','tex');
