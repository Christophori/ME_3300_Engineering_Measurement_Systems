...
% in R. 
volt_data = readtable('../Data/time_volts_data_example.csv');
...
data = readmatrix("../Data/time_volts_data_example.csv");
...
exportgraphics(better_fig,"..\Figures\My_Awesome_Voltage_Scatter.png",Resolution=600) % for reports/presentations
exportgraphics(better_fig,"..\Figures\My_Awesome_Voltage_Scatter.pdf",Resolution=600) % for canvas submission 
...
exportgraphics(historgram_fig,"..\Figures\My_Awesome_Voltage_Hist.png",Resolution=600)
exportgraphics(historgram_fig,"..\Figures\My_Awesome_Voltage_Hist.pdf",Resolution=600)
...
exportgraphics(curve_fit_fig,"..\Figures\My_Curve_Fit.png",Resolution=600)
exportgraphics(curve_fit_fig,"..\Figures\My_Curve_Fit.pdf",Resolution=600)
...
% save the figure to file
exportgraphics(historgram_fig_2,"..\Figures\My_PDFs.png",Resolution=600)
exportgraphics(historgram_fig_2,"..\Figures\My_PDFs.pdf",Resolution=600)